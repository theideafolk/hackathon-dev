...
const FloatingCountdown: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-5 left-1/2 transform -translate-x-1/2 z-[9999] pointer-events-auto">
      <motion.div 
        className="bg-black/90 backdrop-blur-xl border border-[#00A3FF]/20 rounded-lg shadow-lg"
